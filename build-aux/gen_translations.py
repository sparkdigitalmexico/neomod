...
def build_translations_h(msgids: list[str]) -> str:
    # plain C arrays instead of std::to_array: avoids a fat per-TU template instantiation
    # in every TU that includes i18n.h
...
inline constexpr std::string_view TRANSLATABLE_STRINGS[] = {
"""
